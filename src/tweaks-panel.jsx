/* Reusable Tweaks shell + form-control helpers (from the design bundle).
   Floating panel: accent theme, dark mode, card radius, uppercase toggle. */
    ...
    <>
      ...
      {!open && (
        <button onClick={() => setOpen(true)} title="Tweaks"
          style={{ position:'fixed', right:16, bottom:16, zIndex:2147483646,
            width:44, height:44, borderRadius:12, border:'none', cursor:'pointer',
            background:'rgba(20,30,29,.82)', color:'#cfe9e2',
            backdropFilter:'blur(18px)', boxShadow:'0 8px 24px rgba(0,0,0,.3)',
