...
const L = {
  ...
  car:'<path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-.6 0-1.1.4-1.4.9l-1.5 2.8C2.4 11 2 11.5 2 12v4c0 .6.4 1 1 1h2"/><circle cx="7" cy="17" r="2"/><path d="M9 17h6"/><circle cx="17" cy="17" r="2"/>',
  ...
  'calendar-dot':'<path d="M8 2v4"/><path d="M16 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18"/>',
  // ----- settings / prefs -----
  ...
  glass:'<path d="M8 22h8"/><path d="M12 11v11"/><path d="m19 3-7 8-7-8Z"/>',
  ...
  // ----- gearbox / drivetrain (figma-custom; not in lucide) -----
  'auto':'<circle cx="12" cy="12" r="9"/><text x="12" y="16" text-anchor="middle" font-size="11" font-weight="800" fill="currentColor" stroke="none" font-family="system-ui">A</text>',
  awd:'<circle cx="7" cy="7" r="2.4"/><circle cx="17" cy="7" r="2.4"/><circle cx="7" cy="17" r="2.4"/><circle cx="17" cy="17" r="2.4"/><path d="M9.4 7h5.2M9.4 17h5.2M7 9.4v5.2M17 9.4v5.2"/>',
...
export function Icon({name, size=24, stroke=2, fill=false, color, style, className}){
  const markup = L[name];
  const filled = fill || name.endsWith('-fill');
  if(!markup) return React.createElement('svg',{width:size,height:size,viewBox:'0 0 24 24'});
  return React.createElement('svg',{
    width:size, height:size, viewBox:'0 0 24 24',
    fill: filled ? 'currentColor' : 'none',
    stroke:'currentColor', strokeWidth: filled ? 0 : stroke,
    strokeLinecap:'round', strokeLinejoin:'round',
    style: Object.assign(color?{color}:{}, style||{}), className,
