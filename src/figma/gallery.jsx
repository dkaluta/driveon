...
const SCREENS = [
  ...
  ['Driver · Digital key · Locked', Dr.DigitalKey, {mode:'driver',params:{id:'seat-ibiza',unlocked:false}}],
  ['Driver · Digital key · Unlocked', Dr.DigitalKey, {mode:'driver',params:{id:'seat-ibiza',unlocked:true}}],
